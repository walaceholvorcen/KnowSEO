...
// HTML vira texto corrido, sem marcação. Usado para dar ao Claude o
// conteúdo real do artigo (não o HTML) como base do carrossel - sem isso o
// prompt ficaria poluído de tag e o modelo poderia "citar" um <strong>
// como se fosse texto.
